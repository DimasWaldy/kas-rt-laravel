    ...
    <article class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
        ...
        <div class="grid gap-8 p-6 sm:p-8 lg:grid-cols-3">
            <div class="lg:col-span-2">
                ...
                <p class="mt-2 text-sm font-semibold text-slate-500">Milik {{ $umkm->pemilik?->name }} · {{ $umkm->rt?->name ?? 'Lingkup RW' }}</p>
            ...
            <aside class="space-y-4">
                <div class="rounded-2xl bg-slate-50 p-5">
                    <dl class="space-y-4 text-sm">
                        ...
                        <div><dt class="text-xs font-bold uppercase tracking-wider text-slate-400">Jam operasional</dt><dd class="mt-1 font-semibold text-slate-700">{{ $umkm->jam_operasional ?: 'Hubungi pemilik' }}</dd></div>
