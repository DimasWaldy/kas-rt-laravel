...
<div class="mx-auto max-w-3xl">
    ...
    <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <h1 class="text-2xl font-black text-slate-900">Buat Kegiatan</h1>
        <p class="mt-2 text-sm text-slate-500">Tentukan agenda untuk seluruh RW atau khusus RT sesuai kewenangan Anda.</p>
