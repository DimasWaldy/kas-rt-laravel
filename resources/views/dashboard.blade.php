...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-5">
        ...
        <p class="text-xs font-medium text-slate-500">KK terdaftar</p>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-5">
        ...
        <p class="text-xs font-medium text-slate-500">KK aktif</p>
        <p class="text-2xl font-semibold text-slate-900 mt-0.5">{{ $kepalaKeluargaAktif ?? 0 }}</p>
        <p class="text-xs text-slate-400 mt-1">dari {{ $totalKK ?? 0 }} KK</p>
    </div>
...
<div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
    ...
    {{-- Kolom kiri: ringkasan bulan ini + top KK --}}
    <div class="flex flex-col gap-6">
        ...
        {{-- Top 5 KK --}}
        <div class="bg-white rounded-2xl border border-slate-200 p-5">
            <p class="text-sm font-semibold text-slate-800 mb-4">Top 5 KK — total iuran</p>

            @forelse($topKKIuran as $index => $topKK)
                <div class="flex items-center justify-between gap-3 py-2.5 {{ !$loop->last ? 'border-b border-slate-100' : '' }}">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400">KK {{ $topKK->no_kk }}</p>
                        </div>
                    </div>
